	...
	<div class="player" v-show="playlist.length>0">
		...
		>
			<div class="normal-player" v-show="fullScreen">
				...
				<div class="middle">
					<div class="middle-l">
						<div class="cd-wrapper" ref="cdWrapper" :class='cdAfterCls'>
							<div class="cd-outer" :class="cdCls">
...
<script type="text/ecmascript-6">
	...
	export default {
		...
		computed:{
			cdAfterCls(){
				return this.playing ? 'playState':'stopState'
			},
			cdCls(){
...
<style lang="stylus" rel="stylesheet/stylus">
				...
				.middle-l
					...
					.cd-wrapper
						...
						&:after
							...
							top -70px
							left 129px
							background-image url('~common/images/play_needle.png')
						...
						&:before
							content: ''
							background-image:url('~common/images/disc-ip6.png')
							left: 0
							right: 0
							top: 0
							bottom: 0
						...
						.cd-outer
							...
							&:before
								content: ''
								background-image:url('~common/images/disc_light-ip6.png')
								left: 0
								right: 0
								top: 0
								bottom: 0
	...
	.mini-player
		...
		&.mini-center-active,.mini-leave-active
			transition all .4s
